Feature: Carteira
  ...
  Scenario: Tentar criar carteira que já existe
    Dado que exista carteira para o usuário "user-002"
    Quando eu tentar criar a carteira para o usuário "user-002"
    Então deve retornar erro de carteira já existe
